...
Extends the WooCommerce reviews and add a histogram table to the reviews of your products, such as you see in most trendy e-commerce sites.

== Description ==

Add a histogram table to the reviews of your products, such as you see in most trendy e-commerce sites, and give users the possibility to attach images to their reviews. Keep up-to-date about most trendy products thanks to the new options conceived to manage an advanced review system.
...
= Version 1.7.0 - Released on 07 October 2021 =

* Fix: Bad version name

= Version 1.6.2 - Released on 07 October 2021 =

* New: support for WooCommerce 5.8
* Update: YITH plugin framework 

= Version 1.6.1 - Released on 27 September 2021 =

* Update: YITH plugin framework
* Fix: debug info feature removed for all logged in users 

= Version 1.6.0 - Released on 07 September 2021 =

* New: support for WooCommerce 5.7
* Update: YITH plugin framework

= Version 1.5.9 - Released on 17 August 2021 =

* New: support for WooCommerce 5.6
* Update: YITH plugin framework

= Version 1.5.8 - Released on 09 July 2021 =

* New: Support for WordPress 5.8
* Update: YITH Plugin Framework
* Fix: missing FW file

= Version 1.5.7 - Released on 07 Jul 2021 =

* New: Support for WooCommerce 5.5
* Update: YITH Plugin Framework

= Version 1.5.6 - Released on 04 Jun 2021 =

* New: Support for WooCommerce 5.4
* Update: YITH Plugin Framework

= Version 1.5.5 - Released on 18 May 2021 =

* New: Support for WooCommerce 5.3
* Update: YITH Plugin Framework

= Version 1.5.4 - Released on 08 April 2021 =

* New: Support for WooCommerce 5.2
* Update: YITH Plugin Framework
* Dev: plugin strings scaped
...
= Version 1.5.1 - Released on 12 January 2021 =

* New: Support for WooCommerce 4.9
* Update: plugin framework updated

= Version 1.5.0 - Released on 04 December 2020 =

* New: Support for WooCommerce 4.8
* Update: plugin framework updated

= Version 1.4.9 - Released on 05 November 2020 =
...
= Version 1.4.8 - Released: Oct 20, 2020 =

* New: support to WooCommerce 4.6
* Update: plugin framework

= Version 1.4.7 - Released: Sept 24, 2020 =

* Fix: removed the Gravatar email from the user image "alt"

= Version 1.4.6 - Released: Sept 17, 2020 =

* New: support to WooCommerce 4.5
* Update: plugin framework

= Version 1.4.5 - Released: May 28, 2020 =

* New: support to WooCommerce 4.2
* Update: plugin framework

= Version 1.4.4 - Released: Mar 27, 2020 =

* New: support to WooCommerce 4.0
* New: support to WordPress 5.4
* Update: plugin framework
* Fix: fixed problem of an option tab

= Version 1.4.3 - Released: Dec 18, 2019 =

* New: support to WooCommerce 3.9
* Update: plugin framework

= Version 1.4.2 - Released: Nov 29, 2019 =

Update: notice handler
Update: plugin framework

= Version 1.4.1 - Released: Nov 11, 2019 =

* New: support for WordPress 5.3
* New: support for WooCommerce 3.8
* Update: YITH Plugin Framework

= Version 1.4.0 - Released: Oct 30, 2019 =

* Update: YITH Plugin Framework

= Version 1.3.9 - Released: Aug 07, 2019 =

* New: Support for WooCommerce 3.7
* Update: YITH Plugin Framework

= Version 1.3.8 - Released: Jun 18, 2019 =

* Update: YITH Plugin Framework

= Version 1.3.7 - Released: May 29, 2019 =

* New: WordPress 5.2 support
* Update: YITH Plugin Framework

= Version 1.3.6 - Released: Apr 23, 2019 =

* Update: Plugin Framework
* Dev: updating the function get_premium_landing_uri
* Update: version of file ywar-rating.php

= Version 1.3.5 - Released: Feb 26, 2019 =

* Update: YITH Plugin Framework

= Version 1.3.4 - Released: Dec 13, 2018 =
...
= Version 1.3.2 - Released: Oct 22, 2018 =
 - Update: YITH Plugin Framework
 - Update: Compatibility with WooCommerce 3.5.0

= Version 1.3.1 - Released: Jun 25, 2018 =
 - Fix: Template warning on WooCommerce status page

= Version 1.3.0 - Released: Jun 7, 2018 =
...
= Version 1.2.9 - Released: Aug 11, 2017 =

* New: support for WooCommerce 3.1.
* New: tested up to WordPress 4.8.
* Update: YITH Plugin Framework

= Version 1.2.8 - Released: May 30, 2017 =

* Fix: average rating shown twice on review's summary.

= Version 1.2.7 - Released: Apr 30, 2017 =

* Update: YITH Plugin Framework.
* Tweak: tested up to WordPress 4.7.4.
* Tweak: changed plugin tags.

= Version 1.2.6 - Released: Apr 05, 2017  =

* Fix: added missing $customer_reviews_label var in ywar-single-product-reviews.php template.

= Version 1.2.5 - Released: Mar 16, 2017  =

* New:  Support to WooCommerce 2.7.0-RC1
* Update: YITH Plugin Framework

= Version 1.2.4 - Released: Jan 16, 2017 =

* New: WordPress 4.7 ready

= Version 1.2.3 - Released: Jun 13, 2016 =

* New: italian localization
* New: spanish localization
* Fixed: unable to edit the review from the review title link
...
* New: filter yith_advanced_reviews_review_content_elements to let third party plugin or theme change the elements to be shown
...
* New: check the review status from a single page.
...
[use](https://yithemes.com/contact/ "Your Inspiration Themes") so we can bundle it into YITH WooCommerce Advanced Reviews languages.
